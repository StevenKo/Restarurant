...
public class CategoryFoodTypesFragment extends ListFragment {

    public CategoryFoodTypesFragment() {

    }

    public static final CategoryFoodTypesFragment newInstance() {
        CategoryFoodTypesFragment f = new CategoryFoodTypesFragment();
        return f;
    }
